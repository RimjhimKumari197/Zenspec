const products=["Motorola Moto G62 5G",
  ...
  // Normalize strings to fix weird characters
  const normalize = str =>
  ...
  // Set up both inputs
  setupSuggestions(".device-1", "suggestions1");
  setupSuggestions(".device-2", "suggestions2");
  setupSuggestions(".search-input", "suggestions3");
